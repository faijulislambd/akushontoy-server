...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@akushontoy.ecx1aku.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("This is akushontoy data sever!");
});

app.listen(port, () => {
  console.log(`Akushontoy server listening on port ${port}`);
});
